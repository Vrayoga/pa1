        ...
        <div class="card overflow-hidden">
          <div class="card-body">
            ...
            <div class="row align-items-start">
              <div class="col-md-7">
                <p class="text-secondary fs-13px mb-3 mb-md-0">Prestasi SMKN 1 Sumenep mencakup pencapaian siswa di bidang akademik dan non-akademik, seperti lomba kompetensi keahlian, olahraga, dan seni, baik di tingkat daerah maupun nasional.</p>
              </div>
